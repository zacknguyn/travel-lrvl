                    ...
                    <div class="islands__container container">
                        ...
                        >
                            ...
                            <p class="islands__description">
                                Da Nang is a coastal city with a 60-km long shoreline. 
                                <br /> With smooth and sandy beaches running across the coast, Da Nang beach is voted 
                                <br /> by Forbes (U.S.) to be 1 of 6 most beautiful beaches in the world
                                beauty of the world.
                            </p>
                        </div>
                    </div>
        ...
        <div class="value__content">
            <div class="value__data">
                ...
                <p class="value__description">
                    ...
                    service for you. We make a charming choices to
            ...
            <div class="value__accordion">
                <div class="value__accordion-item">
                    ...
                    <div class="value__accordion-content">
                        <p class="value__accordion-description">
                            ...
                            city and have a good quality of
                            service.
                        </p>
                    </div>
                </div>
                ...
                <div class="value__accordion-item">
                    ...
                    <div class="value__accordion-content">
                        <p class="value__accordion-description">
                            Provides you places with time properly.
                        </p>
                    </div>
                </div>
                <div class="value__accordion-item">
                    ...
                    <div class="value__accordion-content">
                        <p class="value__accordion-description">
                            We make sure that the places you go to will have a
                            good of security
                        </p>
                    </div>
                </div>
