    ...
    <body>
        ...
        <header class="header" id="header">
            <nav class="nav container">
                    ...
                    >TOURANE<i class="bx bxs-navigation"></i> TRAVEL</a
                >
                ...
                <a target="_blank" href="https://api.whatsapp.com/send?phone=0901982920&text=I want to book a homestay" class="button nav__button">Booking Now</a>
            </nav>
        </header>
        ...
        <footer class="footer section">
            <div class="footer__container container grid">
                <div>
                    <a href="{{ route('homepage') }}" class="footer__logo">
                        TOURANE<i class="bx bxs-navigation"></i> TRAVEL
                    </a>
                    <p class="footer__description">
                        Our vision is to help people find the <br />
                        best hidden places in the city to travel to
                    </p>
                </div>
            ...
            <div class="footer__info container">
                <span class="footer__copy">
                    &#169; Vietnam–Korea University of Information and Communication Technology – VKU. All rigths reserved
                </span>
